...
// Ïîñêîëüêó êîíòðîëëåð îáëàäàåò êðàéíå îãðàíè÷åííûìè âîçììîæíîñòÿìè ïî âûâîäó òåêñòîâûõ ñîîáùåíèé,
// è íàëè÷èå êâàëèôèöèèðîâàííîãî ïåðñîíàëà ðÿäîì íå ïðåäïîëàãàåòñÿ, ìû îãðàíè÷èìñÿ äâóìÿ óíèâåðñàëüíûìè
// ñîîáùåíèÿìè îá îøèáêå.
const std::string StdControllerError = "Îøèáêà êîíòðîëëåðà";
const std::string StdBackendError = "Îøèáêà ïîðòàëà";
