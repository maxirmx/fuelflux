 ...
 * 
 * Internal implementation class for rendering text to framebuffer.
 * This class is used by the concrete display implementations.
 * 
...
public:
    ...
    FourLineDisplayImpl& operator=(const FourLineDisplayImpl&) = delete;
